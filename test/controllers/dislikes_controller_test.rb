...
class DislikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dislike" do
    assert_difference('Dislike.count') do
      post dislikes_url, params: { dislike: { movie_id: @dislike.movie_id, user_id: @dislike.user_id } }, as: :json
    end
  ...
  test "should update dislike" do
    patch dislike_url(@dislike), params: { dislike: { movie_id: @dislike.movie_id, user_id: @dislike.user_id } }, as: :json
    assert_response 200
  end
